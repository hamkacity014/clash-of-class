...
import { Volume2, VolumeX, Swords, ShieldCheck, Database, Radio } from 'lucide-react';
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-slate-800/80 bg-slate-950/80 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        {/* Right Section: Status Indicator, Sound, and Host Link */}
        <div className="flex items-center gap-3">
          {/* Cloud vs Local Indicator */}
          <div className="hidden sm:flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium border border-slate-800 bg-slate-900/90 text-slate-300">
          ...
          <button
            ...
            className="w-9 h-9 rounded-lg border border-slate-800 bg-slate-900 hover:bg-slate-800 flex items-center justify-center text-slate-300 hover:text-white transition-colors"
